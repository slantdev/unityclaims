...
/**
 * Template part for displaying white papers list content block
 */
...
// Query white paper articles
$white_papers = new WP_Query(array(
  'post_type' => 'claims-whitepapers',
  'posts_per_page' => -1,
  'orderby' => 'date',
  'order' => 'DESC'
));
...
<div class="cards">
  <?php if (!empty($cards_list)): ?>
    ...
    <?php endforeach; ?>
  <?php else: ?>
    <div class="errorMessage">No white papers available</div>
  <?php endif; ?>
</div>
